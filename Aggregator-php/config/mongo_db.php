...
$config['mongo_db']['default']['username'] = 'aggregator-php-test';
$config['mongo_db']['default']['password'] = 'noo6pai7Iephahzi';
$config['mongo_db']['default']['database'] = 'aggregator-php-test';
